...
public partial class StoreMinMax3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
	    ...
	    if (strAccessType == "R")
	    {
		    ...
		    labelForm.InnerText = "Valores Mínimo-Máximo (Acceso solo Lectura)";
	    }
	    ...
	    if (strAccessType == "F")
	    {
		    ...
		    labelForm.InnerText = "Valores Mínimo-Máximo  (Acceso Completo)";
	    }
    ...
    private void LoadBrands()
    {
        ...
        try
        {
            ...
            @"select brand from
                ...
                union
                select distinct 2 as sortorder, replace(U_U_UETA_Marca, '''','_') brand 
                from " + sap_db + @".dbo.oitm 
                where	itmsgrpcod in (" + itmsgrpcods + @") 
                and U_U_UETA_Marca is not null 
                ) a
