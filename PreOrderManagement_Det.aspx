<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="PreOrderManagement_Det.aspx.cs" Inherits="PreOrderManagement_Det" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function HidePnl() {
            document.getElementById('<%= lblWebOrderNumber.ClientID %>').innerText = "";
            document.getElementById('<%= lblCustomerName.ClientID %>').innerText = "";
            document.getElementById('<%= lblPassportNumber.ClientID %>').innerText = "";
            document.getElementById('<%= lblFlight.ClientID %>').innerText = "";
            document.getElementById('<%= lblPickupDate.ClientID %>').innerText = "";
            document.getElementById('<%= lblPrintDate.ClientID %>').innerText = "";
            document.getElementById('<%= lblUser.ClientID %>').innerText = "";
            document.getElementById('<%= lblInvoiceNumber.ClientID %>').innerText = "";
            document.getElementById('<%= lblFlightDate.ClientID %>').innerText = "";
            document.getElementById('<%= lblFlightTime.ClientID %>').innerText = "";
            document.getElementById('<%= lblQty.ClientID %>').innerText = "";
            document.getElementById('<%= lblEstatus.ClientID %>').innerText = "";
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <asp:Panel ID="pnlPromoHeader" runat="server" CssClass="Panel">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            &nbsp;&nbsp;
                            <label class="myLabelXtraSmall">Estado</label>
                            <tel:RadComboBox ID="rcbStatus" runat="server" Height="60px" DropDownAutoWidth="Disabled" Width="100px"
                                ...
                                <Items>
                                    ...
                                    <tel:RadComboBoxItem runat="server" Text="Pending" Value="1" />
                                    <tel:RadComboBoxItem runat="server" Text="Invoiced" Value="2" />
                                    <tel:RadComboBoxItem runat="server" Text="Not Invoiced" Value="3" />
                                </Items>
                            </tel:RadComboBox>
                            &nbsp;&nbsp;
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <tel:RadComboBox ID="rcbPrinted" runat="server" Height="60px" DropDownAutoWidth="Disabled" Width="100px"
                                ...
                                <Items>
                                    <tel:RadComboBoxItem runat="server" Text="All" Selected="true" Value="0" />
                                    <tel:RadComboBoxItem runat="server" Text="Yes" Value="Y" />
                                    <tel:RadComboBoxItem runat="server" Text="No" Value="N" />
                                </Items>
                            </tel:RadComboBox>
                            &nbsp;&nbsp;
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <tel:RadGrid ID="rgHead" runat="server" 
                    Width="100%"
                    ShowStatusBar="true" 
                    ...
                    OnItemCommand="rgHead_ItemCommand">
                    <PagerStyle Mode="Slider"></PagerStyle>
                    <SortingSettings EnableSkinSortStyles="false" />
                    <ExportSettings OpenInNewWindow="true" IgnorePaging="true" UseItemStyles="true" Excel-Format="Xlsx" HideStructureColumns="true" FileName="WebOrdersStatus" />
                    <MasterTableView Width="100%" AllowNaturalSort="false" DataKeyNames="InvoiceNumber,MagentoOrderNumber" CommandItemDisplay="Top">
                        ...
                        <Columns>
                            ...
                            <tel:GridBoundColumn SortExpression="MagentoOrderNumber" HeaderText="No. Orden Magento" HeaderButtonType="TextButton" DataField="MagentoOrderNumber" UniqueName="MagentoOrderNumber" HeaderStyle-Width="122px" />
                            ...
                            <tel:GridBoundColumn SortExpression="FlightDate" HeaderText="Flight Date" HeaderButtonType="TextButton" DataField="FlightDate" UniqueName="FlightDate" DataFormatString="{0:d}" HeaderStyle-Width="80px" />
                            <tel:GridBoundColumn SortExpression="FlightTime" HeaderText="Flight Time" HeaderButtonType="TextButton" DataField="FlightTime" UniqueName="FlightTime" DataFormatString="{0:hh\:mm}" HeaderStyle-Width="80px" />
                            
                            <tel:GridBoundColumn SortExpression="SubTotal" HeaderText="SubTotal" HeaderButtonType="TextButton" DataField="SubTotal" UniqueName="SubTotal" DataFormatString="{0:#,##0.00}" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="95px" />
