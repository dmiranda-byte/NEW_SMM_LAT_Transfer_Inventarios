<%@ Page Title="Sube Bines por Excel" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="BinByExcel.aspx.cs" Inherits="BinByExcel" %>
        ...
        <div class="row">
            <div class="col-md-8">
                <asp:Panel ID="pnlAddApps" runat="server" CssClass="page-curl shadow-bottom">
                    <label ID="labelForm" runat="server" class="PanelHeading">Subir Bines por Excel</label>
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="myUL">
                                <li>
                                ...
                                <li>
                                    ...
                                    <asp:Button ID="btnCreateDraft" runat="server" Text="Crear Bins" OnClick="btnCreateDraft_Click" OnClientClick="return confirm('ALERTA!!\n\nEsta Seguro Que Quiere Crear/Actualizar Bines Con El Excel Seleccionado?\n\nClick OK para Crear o Cancel para No Crear')" CssClass="mybtnmeduim" />
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-4">
