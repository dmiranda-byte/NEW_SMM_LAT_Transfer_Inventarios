...
public partial class DeliveryErrors : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
	    ...
	    if (strAccessType == "R")
		{
		    ...
		    labelForm.InnerText = "Errores de Delivery (Acceso solo Lectura)"; //////////<<<<<<<<
	    ...
	    if (strAccessType == "F")
		{
		    ...
		    labelForm.InnerText = "Errores de Delivery (Acceso Completo)"; //////////<<<<<<<<
    ...
    protected void rgHead_UpdateCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        try
        {
            ...
            {
                flagokay = 'N';
                string message = "EL Usuario " + lCurUser + ", con Rol " + strRole_Description + " no tiene permisos para actualizar en esta pantalla.";
                //string url = string.Format("Default.aspx");
                string script = "{ alert('";
                script += message;
                script += "');";
