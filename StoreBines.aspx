                        ...
                        <div class="col-md-7">
                            <ul class="myUL">
                                ...
                                <li>
                                    ...
                                    &nbsp; 
                                    <asp:Button ID="MinUpdBotton" runat="server" OnClick="MinUpdBotton_Click" Text="Actualiza Minimos al" CssClass="mybtnlarge" ToolTip="Min Up" Visible="False" />
                                    &nbsp; 
                                ...
                                <li>
                                    <asp:CheckBox ID="NotMinMaxPlannedCheckBox" runat="server" Text="Productos no planificados con inventario disponible en Bodegas" AutoPostBack="True" OnCheckedChanged="NotMinMaxPlannedCheckBox_CheckedChanged" CssClass="myCheckboxList myLabel" Visible="False" />
                                </li>
                                <li>
                                ...
                                <li>
                                    <asp:CheckBox ID="NotInSapCheckBox" runat="server" Text="Productos que no existen en SAP aun" AutoPostBack="True" OnCheckedChanged="NotInSapCheckBox_CheckedChanged" CssClass="myCheckboxList myLabel" Visible="False" />
                                </li>
                                <li>
...
<%--                        <ColumnGroups>
                        ...
                        <Columns>
                            <tel:GridBoundColumn SortExpression="itemcode" HeaderText="Articulo" HeaderButtonType="TextButton" DataField="itemcode" UniqueName="itemcode" HeaderStyle-Width="100px" />
                            ...
                            <tel:GridBoundColumn SortExpression="itmsgrpnam" HeaderText="Categoria" HeaderButtonType="TextButton" DataField="itmsgrpnam" UniqueName="itmsgrpnam" HeaderStyle-Width="100px" />
                            <tel:GridBoundColumn SortExpression="u_brand" HeaderText="Marca" HeaderButtonType="TextButton" DataField="u_brand" UniqueName="u_brand"  HeaderStyle-Width="100px" />
