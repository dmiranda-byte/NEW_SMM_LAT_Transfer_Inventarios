<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="R_DetalledeItemsporBinsTiendas.aspx.cs" Inherits="R_DetalledeItemsporBinsTiendas" %>
        ...
        <div class="row">
            <div class="col-md-8">
                <asp:Panel ID="pnlPromoHeader" runat="server" CssClass="Panel">
                    <label class="PanelHeading">Detalle de Items por Bines</label>
                    <div class="row">
                        <div class="col-md-4">
                            &nbsp;&nbsp;
                            <label class="myLabelSmall">Num. Bin</label>
                    ...
                    <MasterTableView Width="100%" DataKeyNames="PRODUCT" Name="BinesDesp" AllowNaturalSort="false" CommandItemDisplay="Top" ShowFooter="true" FooterStyle-Font-Bold="true">
                        ...
                        <Columns>
                            ...
                            <tel:GridBoundColumn SortExpression="DESCRIPT" HeaderText="Descripcion" HeaderButtonType="TextButton"
                                DataField="DESCRIPT" UniqueName="DESCRIPT" HeaderStyle-Width="300px" ItemStyle-Wrap="false" />
