<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="MaintainVideosOperativos.aspx.cs" Inherits="MaintainVideosOperativos" %>
        ...
        <div class="row">
            <div class="col-md-5">
                <asp:Panel ID="pnlAddApps" runat="server" CssClass="Panel" Height="210px">
                    <label class="PanelHeading">Agregar Videos Operativos</label>
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="myUL">
                                <li>
            ...
            <div class="col-md-5">
                <asp:Panel ID="Panel1" runat="server" CssClass="Panel" Height="210px">
                    <label class="PanelHeading">Videos Operativos Sobre Actualizaciones</label>
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="myUL">
                                <li>
