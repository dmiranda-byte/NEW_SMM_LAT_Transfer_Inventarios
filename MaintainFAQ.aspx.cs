...
public partial class MaintainFAQ : System.Web.UI.Page
{
    ...
    protected void rbtnAddFaq_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                string v_Message = dm.UpdateFAQs("I", "", rtbCasos.Text, rtbSoluciones.Text, v_FileExt, rtbSolucionLink.Text, Session["UserId"].ToString());
                int dummy = 0;
    ...
    protected void rcbCasos_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
    {
        try
        {
            dt = dm.GetFAQsByID(rcbCasos.SelectedValue);
    ...
    protected void rtbUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                string v_Message = dm.UpdateFAQs("U", rcbCasos.SelectedValue, rtbUCasos.Text, rtbUSoluciones.Text, v_FileExt, rtbUSolucionLink.Text, Session["UserId"].ToString());
    ...
    protected void rtbDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string v_Message = dm.UpdateFAQs("D", rcbCasos.SelectedValue, "", "", "", "", "");
